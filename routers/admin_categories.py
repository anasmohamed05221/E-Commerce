...
async def create_category(request: Request, db: db_dependency, tenant: tenant_dependency, admin: admin_dependency, body: CategoryCreate):
    """Create a new category. Admin only."""
    category = await CategoryService.create_category(db, tenant.id, body.name, body.description)
