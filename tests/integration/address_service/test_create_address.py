...
async def test_create_address_success(session, verified_user, test_tenant):
    ...
    address = await AddressService.create_address(session, tenant_id=test_tenant.id, user_id=verified_user.id, data=data)
...
async def test_create_address_first_is_auto_default(session, verified_user, test_tenant):
...
async def test_create_address_explicit_default_clears_previous(session, verified_user, test_address, test_tenant):
...
async def test_create_address_not_default_preserves_existing_default(session, verified_user, test_address, test_tenant):
...
async def test_create_address_optional_fields_saved(session, verified_user, test_tenant):
