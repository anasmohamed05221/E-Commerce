...
async def test_delete_product_blocked_by_order(session, verified_user, product_factory, test_address, test_tenant):
...
async def test_delete_product_removes_cart_items(session, verified_user, product_factory, test_tenant):
